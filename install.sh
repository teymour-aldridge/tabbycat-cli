...
function install {
	...
	case "${OS}_${ARCH}" in
	"darwin_amd64")
		URL="https://github.com/teymour-aldridge/tabbycat-cli/releases/download/v0.3.0/tabbycat-x86_64-apple-darwin.tar.xz"
		FTYPE=".tar.xz"
		;;
	"darwin_arm64")
		URL="https://github.com/teymour-aldridge/tabbycat-cli/releases/download/v0.3.0/tabbycat-aarch64-apple-darwin.tar.xz"
		FTYPE=".tar.xz"
		;;
	"linux_amd64")
		URL="https://github.com/teymour-aldridge/tabbycat-cli/releases/download/v0.3.0/tabbycat-x86_64-unknown-linux-gnu.tar.xz"
		FTYPE=".tar.xz"
		;;
	"linux_arm64")
		URL="https://github.com/teymour-aldridge/tabbycat-cli/releases/download/v0.3.0/tabbycat-aarch64-unknown-linux-gnu.tar.xz"
		FTYPE=".tar.xz"
		;;
	*) fail "No asset for platform ${OS}-${ARCH}";;
	...
	if [[ $FTYPE = ".gz" ]]; then
		...
		bash -c "$GET $URL" > "tabbycat-cli_${OS}_${ARCH}" || fail "download failed"
	else
